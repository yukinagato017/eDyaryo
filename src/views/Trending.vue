      ...
      <div class="card" v-for="(newsfeeds, i) in newsfeed" :key="i">
        ...
        <div class="dates">
          ...
          <span class="share">
            ...
            Share</span
          >
          <iframe src="https://www.facebook.com/plugins/share_button.php?href=https%3A%2F%2Fedyaryo.netlify.app%2Ftrending&layout=button_count&size=small&appId=2901853709885468&width=77&height=20" width="77" height="20" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>
        </div>
        <div class="title">
